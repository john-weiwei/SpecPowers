---
description: Optimized mode for small changes — skip brainstorm/specify/plan, go directly to code
handoffs:
...
4. If not small: suggest upgrading to full pipeline (`/specpowers-brainstorm` or `/specpowers-specify`)
5. Generate 3-5 item acceptance checklist
6. User completes their own coding, then runs `/specpowers-build`
