...
Load the specpowers skill context, then follow `prompts/build.md`.
...
5. Verify: full mode checks delta spec Scenario THEN entries; fast mode checks delta spec Scenario (3-5)
