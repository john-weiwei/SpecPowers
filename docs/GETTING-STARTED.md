# SpecPowers 完整指南(Getting Started)

> 本文档是 SpecPowers 的**完整使用指南**(由原 README 全文迁移而来),涵盖安装、前置依赖、流水线详解、四条路径对比、apply 阶段详解、架构、项目结构与团队协作。
> 日常速览(安装 + 核心命令 + 升级)请看仓库根 [README.md](../README.md)。
